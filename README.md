...
[![Version](https://img.shields.io/badge/version-4.0.3-blue)](https://github.com/voiceittech/voiceit3-android-sdk)
...
```groovy
dependencies {
    implementation 'com.voiceittech:voiceit3-android-sdk:4.0.3'
}
```
